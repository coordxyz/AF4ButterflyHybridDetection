...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--encoder_nc', type=int, default=3, help='zy:# of encoder received image channels')
        self.parser.add_argument('--decoder_nc', type=int, default=3, help='zy:# of decoder output feature channels')
        self.parser.add_argument('--kRef', type=int, default=2, help='zy:# of reference images')
        ...
        self.parser.add_argument('--anomaly_source_paths', type=str, default='./Datasets/Images4TrainAFnonhybrid/List/test_nonsignalhybrid/')
        ...
        self.parser.add_argument('--block_aug', action='store_true',
                                 help='zy, if specified, keep block region and set others as black, test splicing connector')
        self.parser.add_argument('--reflect_aug', action='store_true',
                                 help='zy, if specified, reflect border regions of rgb, set corresponding regions as white in edge map')
        ...
        self.parser.add_argument('--use_edgemask', type=float, default=1.0,
                                 help='zy, if specified, add noise to edgemap in mask regions')
        self.parser.add_argument('--use_clipvfeat', action='store_true',
                                 help='zy, if specified, add clip visual feature to encoder_out')
    ...
    def parse(self, save=True):
        ...
        # print(">>>checkpoint name:", self.opt.name)
