from sklearn.metrics import recall_score, precision_score, f1_score, roc_auc_score, accuracy_score, average_precision_score
import numpy as np
...
def evaluate(scores, labels, reversed=False):
    ...
    pr_auc = average_precision_score(gt, preds, average="weighted")
