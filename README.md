...
### Training
1. Download training data (Images4TrainClassifier) from https://drive.google.com/file/d/1MLIP8gbKVm_A0a5HTowBvfzsuRk7j37u/view?usp=drive_link. Images4TrainClassifier consists of original challenge images and the images(filename:AF_*.png) generated by AnomalyFactory. The structure of downloaded folder is shown below. 
```
   Images4TrainClassifier
    ├── Images
    │   ├── hybrid/...
